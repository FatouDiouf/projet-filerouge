...
// Returns the private 'App\Repository\UsersimpleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UsersimpleRepository.php';

return $this->privates['App\\Repository\\UsersimpleRepository'] = new \App\Repository\UsersimpleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
