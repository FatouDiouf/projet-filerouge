...
// Returns the private 'App\Repository\AdminsimpleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdminsimpleRepository.php';

return $this->privates['App\\Repository\\AdminsimpleRepository'] = new \App\Repository\AdminsimpleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
