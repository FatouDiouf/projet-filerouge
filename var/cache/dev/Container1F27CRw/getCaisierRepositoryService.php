...
// Returns the private 'App\Repository\CaisierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CaisierRepository.php';

return $this->privates['App\\Repository\\CaisierRepository'] = new \App\Repository\CaisierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
